...
const getStudyPostsList = async (
    ...
    try {
      ...
      const response = await api.get(`/study/${studyId}/post`, {
        params: params,
      });
    //   console.log(params);
  ...
  const createStudyPost = async (studyId, postData) => {
    try {
      const response = await api.post(`/study/${studyId}/post`, postData);
  ...
  export {getStudyPostsList, createStudyPost};