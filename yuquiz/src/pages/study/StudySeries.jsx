...
const StudySeries = () => {
  ...
  const handleCreateSeries = async () => {
    ...
    try {
      await createSeries({ name: newSeriesName, studyId: studyId });
      const updatedSeriesList = await getStudySeriesList(
        studyId,
        "",
        "DATE_DESC",
        currentPage
  ...
  const handleEditSeries = async (seriesId, newName) => {
    try {
      await updateSeries(seriesId, { name: newName, studyId: studyId });
