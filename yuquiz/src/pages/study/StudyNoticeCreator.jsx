...
const StudyNoticeCreator = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await createStudyNotice(studyId, request);
      toast.success("공지 작성 성공!");
      navigate(`/study/${studyId}/notices`);
    } catch (error) {
      toast.error("공지 작성에 실패했습니다. 다시 시도해주세요.");
    }
  };
    ...
    <PageContainer>
      <Card>
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <StyledLink to={`/study/${studyId}/notices`}>목록으로</StyledLink>
        </Form>
      </Card>
    </PageContainer>
  );
...
export default StudyNoticeCreator;
